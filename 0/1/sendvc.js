module.exports.config = {
    ...
    credits: 'ManhG',
    hasPermssion: 2,
    description: '[Ban/Unban/Remove] قائمة المواضيع التي انضمت إليها الروبوتات',
    commandCategory: '',
        ...
        case "reply":
            {
                if (arg[0] == "ban" || arg[0] == "Ban") {
                    ...
                    api.sendMessage(`» إشعار من المسؤول «\n تم حظر مجموعتك من استخدام برامج الروبوت.`, idgr, () =>
                        api.sendMessage(`${global.data.botID}`, () =>
                            api.sendMessage(`» المجلس التنفيذي «(true/false) «\n\n${msg}`, threadID, () =>
