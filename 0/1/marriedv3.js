...
module.exports.onLoad = async() => {
    ...
    const path = resolve(__dirname, 'cache/canvas', 'متزوجv3.png');
...
async function makeImage({ one, two }) {
    ...
    let batgiam_img = await jimp.read(__root + "/متزوجv3.png");
...
module.exports.run = async function ({ event, api, args }) {    
    ...
    if (!mention[0]) return api.sendMessage("يرجى الإشارة إلى شخص واحد.", threadID, messageID);
    else {
