...
try {
const resApi = `https://sensui-useless-apis.codersensui.repl.co/api/tools/blackai?question=act%20as%20a%20human,%20your%20name%20is%20Yoora,%20I'm%20${name},`
...
const audioApi = await axios.get(`https://api.tts.quest/v3/voicevox/synthesis?text=${encodeURIComponent(text)}&speaker=4&fbclid=IwAR01Y4UydrYh7kvt0wxmExdzoFTL30VkXsLZZ2HjXjDklJsYy2UR3b9uiHA`);
